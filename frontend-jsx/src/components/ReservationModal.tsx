...
export default function ReservationModal(props : DropDownButtonProps){
    let uniqueid = JSON.stringify(props);
    ...
    return(
        <div class="modal fade" id={uniqueid} tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id={uniqueid +"event-name"}></input>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id = {uniqueid+'confirmButton'}>Confirm</button>
