...
export default class MiniCrypt {
   ...
   */
  constructor(private its = 1e5, private keyL = 64, private saltL = 16, private digest = "sha256") {
    this.its = its;
    this.keyL = keyL;
    this.saltL = saltL;
    this.digest = digest;
   ...
   */
  check(pw: string, salt: string, hash: string): boolean {
